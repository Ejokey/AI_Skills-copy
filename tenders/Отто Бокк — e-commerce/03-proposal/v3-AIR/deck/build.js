/* КП «Отто Бокк — интернет-магазин» — генератор HTML-слайдов (AIR / ООО «КСИИ», 1280x720)
   Источник: 03-proposal/v2-пайплайн/КП_Ottobock_структура.md (21 слайд), адаптировано под юрлицо AIR
...
function footer(num) {
  return `
    <div class="footer">
      <div>Коммерческое предложение · Интернет-магазин Ottobock · AIR</div>
...
${slideOpen('dark')}
  ...
  <div class="title-footer">
    <div>
      ...
      <div class="tf-muted">Владислав Лицин · +7 (495) 247-50-54 · info@airelations.io · airelations.io</div>
    </div>
    <div class="tf-right">
...
${slideOpen()}
  ...
  ${body(`  <div class="cards cards-3 cards-compact" style="margin-top:22px">
    ...
    ${card('Стоимость', `<p class="p">2 887 500 ₽<br>НДС не облагается (0%) — ООО «КСИИ» резидент Сколково</p>`)}
...
${slideOpen()}
  ...
  ${body(`  <div class="price-row">
    <div class="price-box">
      ...
      <div class="price-main">2 887 500 ₽</div>
      <div class="price-sub">НДС не облагается (0%)</div>
      <div class="price-total">Итого — 2 887 500 ₽</div>
    </div>
  ...
  <div class="callout" style="margin-top:18px">
    <b>Фиксированная цена, без скрытых платежей.</b> Действительна при неизменности технического задания. ООО «КСИИ» — резидент Сколково, НДС не облагается: в цене нет 22%, которые обычно начисляются сверху.
  </div>`)}
  ${footer(11)}
${slideClose()}
`);
...
${slideOpen('dense')}
  ...
  ${heading('Цифровой консультант в магазине — опция +650 000 ₽', 'НДС не облагается (0%). Итого по опции — 650 000 ₽.')}
  ...
  <div class="price-strip">
    <div><span class="ps-label">Стоимость работ + опция</span><span class="ps-main">3 537 500 ₽</span></div>
    <div><span class="ps-label">НДС</span><span class="ps-main">0%</span></div>
    <div class="ps-accent"><span class="ps-label">Итого</span><span class="ps-main">3 537 500 ₽</span></div>
  </div>`)}
  ${footer(12)}
${slideClose()}
`);
...
${slideOpen('dense')}
  ...
  <div class="contact-strip">
    ...
    <div class="cs-right">
      <div class="cs-org">ООО «КСИИ»</div>
      <div class="cs-contact">Владислав Лицин · +7 (495) 247-50-54 · info@airelations.io · airelations.io</div>
    </div>
  </div>`)}
  ${footer(21)}
${slideClose()}
...
/* карточки, сразу за которыми идёт плашка-вывод (без ничего между ними), — стоят
   вплотную друг к другу фиксированным зазором, остаток высоты уходит вниз слайда,
   а не разрывает контент посередине. Точечно — чтобы не задеть слайды опыта/тарифов,
   где после карточек есть другие блоки (плитки, таблицы) */
...
<head>
<meta charset="utf-8" />
<title>КП — интернет-магазин Ottobock — AIR</title>
<style>${css}</style>
</head>
<body>
${slides.join('\n')}
